...
import frc.robot.commands.auto.AutoNavPaths.*;
...
public class AutoNav extends Command {
    ...
    public AutoNav(String path) {
        ...
        // BezierPoint[] pointsArr = { barrelCp1, barrelCp2, barrelCp3, barrelCp4,
        // barrelCp5, barrelCp6, barrelCp7,
        // barrelCp8, barrelCp9, barrelCp10, barrelCp11, barrelCp12, barrelCp13,
        // barrelCp14, barrelCp15,
        ...
        // BezierPoint[] pointsArr = { slalomCp1, slalomCp2, slalomCp3, slalomCp4,
        // slalomCp5, slalomCp6, slalomCp7,
    ...
    private LinkedList<CoordinatePair> getPoints() throws FileNotFoundException, UnsupportedEncodingException {
        ...
        if (this.path == "Slalom") {
            SlalomCoordinates slalom = new SlalomCoordinates();
            return slalom.slalomList;
        } else if (this.path == "Barrel Racing") {
            BarrelRacingCoordinates barrelRacing = new BarrelRacingCoordinates();
            return barrelRacing.barrelRacingList;
        } else if (this.path == "Bounce") {
            BounceCoordinates bounce = new BounceCoordinates();
            return bounce.bounceList;
        }
        return null;
    }
